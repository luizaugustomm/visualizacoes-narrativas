...
function scroller() {
   ...
   */
  function resize() {
    // sectionPositions will be each secoes
    // starting position relative to the top
    // of the first section.
    sectionPositions = [];
    var startPos;
    secoes.each(function (d, i) {
  ...
  function position() {
    ...
    sectionIndex = Math.min(secoes.size() - 1, sectionIndex);
   ...
   * of the secoes. Useful for if the
