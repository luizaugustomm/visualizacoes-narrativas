...
var scrollVis = function () {
  ...
  var setupVis = function (wordData, fillerCounts, histData) {
    ...
    // count openvis titulo
    g.append('text')
      .attr('class', 'titulo openvis-titulo')
      .attr('x', width / 2)
      .attr('y', height / 3)
      .text('2013');

    g.append('text')
      .attr('class', 'sub-titulo openvis-titulo')
      .attr('x', width / 2)
      .attr('y', (height / 3) + (height / 5))
      .text('OpenVis Conf');

    g.selectAll('.openvis-titulo')
      .attr('opacity', 0);

    // count filler word count titulo
    g.append('text')
      .attr('class', 'titulo count-titulo highlight')
      .attr('x', width / 2)
      .attr('y', height / 3)
      .text('180');

    g.append('text')
      .attr('class', 'sub-titulo count-titulo')
      .attr('x', width / 2)
      .attr('y', (height / 3) + (height / 5))
      .text('Filler Words');

    g.selectAll('.count-titulo')
      .attr('opacity', 0);
    ...
    // cough titulo
    g.append('text')
      .attr('class', 'sub-titulo cough cough-titulo')
      .attr('x', width / 2)
      .attr('y', 60)
      .text('cough')
      .attr('opacity', 0);
   ...
   * these functions to the secoes based on
   * the section's index.
   *
   */
  var setupSections = function () {
    ...
    // Most secoes do not need to be updated
  ...
  /**
   * showTitle - initial titulo
   *
   * hides: count titulo
   * (no previous passo to hide)
   * shows: intro titulo
   *
   */
  function showTitle() {
   ...
   *
   * hides: cough titulo and color
   * (previous passo is also part of the
   ...
   *
   * hides: nothing
   * (previous and next secoes are histograms
...
function display(data) {
  ...
  var scroll = scroller()
    .container(d3.select('#grafico'));

  // pass in .passo selection as the passos
  scroll(d3.selectAll('.passo'));

  // setup event handling
  scroll.on('active', function (index) {
    // highlight current passo text
    d3.selectAll('.passo')
